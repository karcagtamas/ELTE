(* Vizsga: Elmeleti jellegu az eloadas anyagabol, majd egy gyakorlati feladat. Valszeg valami olyasmi, hogy van egy program es egy uj elemet kell belehelyezni, hasonloan a hazifeladathoz. *)
...
(*
  ...
  ------------------------------------------------------------eval_while_true
    ...
    operacios szemantika: relaciok
    denotacios szemantika: fv state => state
...
| ciklus , astate | -=> st.
Proof.
exists (update X 3 (update Y 3 (update X 2 (update Y 1 (update X 1 (update Y 0 (update Y 0 (update X 0 astate)))))))).
unfold ciklus.
apply eval_seq with (s' := (update X 0 astate)).
apply eval_assign.
apply eval_seq with (s' := (update Y 0 (update X 0 astate))).
apply eval_assign.
apply eval_while_true with (s' := (update X 1 (update Y 0 (update Y 0 (update X 0 astate))))).
* simpl. reflexivity.
* apply eval_seq with (s' := (update Y 0 (update Y 0 (update X 0 astate)))).
** apply eval_assign.
** apply eval_assign.
* apply eval_while_true with (s' := (update X 2 (update Y 1 (update X 1 (update Y 0 (update Y 0 (update X 0 astate))))))).
** simpl. reflexivity.
** apply eval_seq with (s' := (update Y 1 (update X 1 (update Y 0 (update Y 0 (update X 0 astate)))))).
*** apply eval_assign.
*** apply eval_assign.
** apply eval_while_true with (s' := (update X 3 (update Y 3 (update X 2 (update Y 1 (update X 1 (update Y 0 (update Y 0 (update X 0 astate))))))))).
*** simpl. reflexivity.
*** apply eval_seq with (s' := (update Y 3 (update X 2 (update Y 1 (update X 1 (update Y 0 (update Y 0 (update X 0 astate)))))))).
**** apply eval_assign.
**** apply eval_assign.
...
1:{ rewrite H2 in IHeval_bigstep2. rewrite H3 in IHeval_bigstep2. apply IHeval_bigstep2. reflexivity. }
Qed.
