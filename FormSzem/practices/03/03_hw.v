...
(* END FIX *)
APlus (AMul (ALit 1) (ALit 2)) (ASub (APlus (ALit 4) (ALit 5)) (ALit 3)).
...
Proof.
intro.
exists (APlus (ALit 0) a). split. simpl. Check inverse. apply inverse. 
unfold "<>". intro. assert (leaves_count (APlus (ALit 0) a) = leaves_count a).
rewrite -> H. simpl. reflexivity.
simpl in H0. apply (seged (leaves_count a)).
assumption.
Qed.
