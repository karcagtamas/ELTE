...
Definition st : state := fun x => 2. (* <- change this so that you can prove e'val! *)
...
Definition e'' : exp := plus (lit 1) (lit 1). (* <- change this so that you can prove e''indep! *)
...
* reflexivity.
* unfold "<>" in n0. assert False. apply n0. reflexivity. destruct H.
Qed.
...
unfold update.
destruct (string_dec x x').
* simpl. exfalso. (*assert False and apply*) apply ne. assumption.
* reflexivity.
Qed.
