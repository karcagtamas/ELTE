...
a típust _parciálisan alkalmazzuk_ úgy, hogy csak egy paraméter hiányozzon. Például, ha
...
A Haskell-ben a legtöbb típusosztálynál vannak ún. _törvények_, amelyek olyan
...
_struktúráját_, kizárólag a tárolt értékekhez nyúlhat. Pl. illegális egy olyan
lista `fmap` definíció, ami megfordítja a listát.

A második törvény egy _hatékonysági_ tulajdonság: ha kétszer egymás után járunk
...
Ha a paraméter típus függvény _bemeneteként_ szerepel, akkor nem létezik
